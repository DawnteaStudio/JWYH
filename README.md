...
3. [프로젝트 구조](#프로젝트-구조)
4. [서비스 기능](#서비스-기능)  
    4.1  [인트로페이지/회원가입/로그인/구글로그인](#시작-기능)
    4.2  [메인 페이지/편지열람/월별 편지 보관함/ 마이페이지(로그인)](#중간-기능)
    4.3  [메인페이지(공유 링크로 입장/ 비로그인/ 편지보내기)](#편지-기능)
    4.4  [404 Page](#추가-기능)
...
# 4. 서비스 기능 <a name="서비스-기능"></a>
***
## 4.1 인트로페이지/회원가입/로그인/구글로그인 <a name="시작-기능"></a>
메인 기능에 대한 내용을 여기에 작성해주세요.

## 4.2 메인 페이지/편지열람/월별 편지 보관함/ 마이페이지(로그인) <a name="중간-기능"></a>
서브 기능에 대한 내용을 여기에 작성해주세요.

## 4.3 메인페이지(공유 링크로 입장/ 비로그인/ 편지보내기) <a name="편지-기능"></a>
서브 기능에 대한 내용을 여기에 작성해주세요.

## 4.4 404 Page <a name="추가-기능"></a>
서브 기능에 대한 내용을 여기에 작성해주세요.

***

# 5. 시연 영상 <a name="시연-영상"></a>

https://github.com/DawnteaStudio/JWYH/assets/90132183/d62d8200-80fd-4592-b9e0-deb893891e7f



# 6. 팀원 소개 <a name="팀원-소개"></a>
***
| 이름 | 역할 | 담당 역할 |
| --- | --- | --- | --- |
| 김대현 | 팀장, FE | 메인페이지 담당 |
